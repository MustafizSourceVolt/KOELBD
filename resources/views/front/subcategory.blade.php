    ...
    {{-- LOOP STARTS --}}
                      ...
                      @endphp
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                      ...
                                      @endphp
                        <a href="{{route('front.product',['id' => $prod->id, 'slug' => $name])}}" class="single-product-area">
                          <div class="product-image-area text-center" style="width: 290px;">
...
{{$curr->sign}}
                        ...
                        <a href="{{route('front.product',['id' => $prod->id, 'slug' => $name])}}" class="single-product-area text-center">
                          <div class="product-image-area" style="width: 290px;">
                                            @if($prod->features!=null && $prod->colors!=null)
                                            @php
                                            $title = explode(',', $prod->features);
                                            $details = explode(',', $prod->colors);
