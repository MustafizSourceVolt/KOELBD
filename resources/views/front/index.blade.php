...
@section('content')
    ...
    @if($gs->slider == 1)
        ...
        <div class="container-fluid">
            <div class="row">
        <div id="bootstrap-touch-slider" class="carousel bs-slider fade control-round indicators-line slider-height col-md-12" data-ride="carousel" data-pause="hover" data-interval="5000">
        @php
            $i=1;
        @endphp
        <!-- Indicators -->
