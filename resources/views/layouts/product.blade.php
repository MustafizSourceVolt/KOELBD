        ...
        @if($lang->rtl == 1)
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-5">
                        <div class="header-menu-wrap">
                            <ul>
                                <li><a href="{{route('front.hot-of-the-fire')}}" style="color: #0a2354;">Latest Collection</a></li>
                                <!--<li><a href="{{route('front.corporate-collaboration')}}" style="color: #0a2354;">Corporate Sales</a></li>-->
                                ...
                                <li><a href="{{route('front.dev-shishu')}}" style="color: #0a2354;">Dev Shishu</a></li>
                                <li><a href="{{route('front.design-hope')}}" style="color: #0a2354;">Design Your Hope</a></li>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-5">
                        ...
                        <h5> ALL CLOTHING <i class="fa fa-bars"></i></h5>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-7 col-xs-12">
                        <div class="footer-copyright-area">
                            <img width="" src="{{asset('assets/front/images/ssl.png')}}" alt="footer image">
                        </div>
                    </div>
                    @else
                    <div class="col-lg-3 col-md-6 col-sm-7 col-xs-12">
