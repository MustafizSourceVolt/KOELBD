...
<header class="header-wrap">
    <div class="header-support-part">
        ...
        <div class="header-middle-area" style="background-color: #0a1ad840; padding-bottom:15px;">
            <div class="container">
                <div class="row">
                ...
                @if($lang->rtl == 1)
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-5">
                        <div class="header-bottom-left-wrap" style="background-color:#f3f3f3;color: #0a2354;">
                            ...
                            <ul class="hidden-md hidden-lg hidden-sm" id="menucatsData" style="background: #0e3b914d;">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="single-footer-wrap information">
                            ...
                            <ul>
                                ...
                                @foreach($pages as $pg)
                                    <li><a href="{{route('front.page',$pg->slug)}}"><i class="fa fa-circle" style="color:#0e3b91;"></i> &nbsp; {{strtoupper($pg->title)}}</a></li>
                                @endforeach
                                <li><a href="{{route('front.contact')}}"><i class="fa fa-circle" style="color:#0e3b91;"></i> &nbsp; CONTACT US</a></li>
