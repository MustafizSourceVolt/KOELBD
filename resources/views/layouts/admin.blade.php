                    ...
                    <div class="sidebar-menu-body">
                        <nav id="sidebar-menu">
                            ...
                            <ul class="list-unstyled components">
                                ...
                                <li>
                                    <a href="{{route('admin-wanted-brand')}}"><i class="fa fa-font-awesome"></i> Wanted Brand</a>
                                </li>
                                <li>
                                ...
                                <li>
                                    ...
                                    <ul class="collapse list-unstyled submenu" id="pageSettings">
                                        <li><a href="{{route('admin-corporate-collaboration')}}"><i class="fa fa-angle-right"></i> Corporate Collaboration</a></li>
                                        <li><a href="{{route('admin-dev-shishu')}}"><i class="fa fa-angle-right"></i> Dev Shishu</a></li>
                                        <li><a href="{{route('admin-design-your-hope')}}"><i class="fa fa-angle-right"></i> Design Your Hope</a></li>
