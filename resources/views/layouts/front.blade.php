...
<head>
    ...
    @endif
    <meta name="author" content="Koel-Shop">
...
<style type="text/css">
    ...
    <style type="text/css">
        ...
        .header-middle-right-wrap i.fa-user, .circle-li i, i.fa-heart  {
            /*background-color: #0e3b91;*/
        }

        .circle-li i, i.fa-user, .header-middle-right-wrap i.fa-heart {
        height: 30px;
        width: 30px;
        background: #004b80;
        border-radius: 100%;
...
<script async src="https://www.googletagmanager.com/gtag/js?id=G-YTY56E1W65"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-YTY56E1W65');
</script>
...
@endif
    ...
    <header class="header-wrap">
        <div class="header-support-part">
            ...
            <div class="header-middle-area" style="padding-bottom:15px;">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                            <div class="header-middle-left-wrap">
                                <div class="logo">
                                    ...
                                    <img src="{{asset('assets/images/'.$gs->logo)}}" alt="Logo" width="75%">
                                    </a>
                                    @if($gs->reg_vendor == 1)
                                    <span class="sell-btn">
            @if(Auth::guard('user')->check())
    ...
    @else
            ...
            <!--                    <ul>-->
            <!--            @if($gs->reg_vendor == 1)-->
            <!--                        <li class="sell-btn" style="width: 250px;text-align: center;">-->
            <!--@if(Auth::guard('user')->check())-->
            <!--<a href="{{route('user-dashboard')}}">{{$lang->sale}}</a>-->
            <!--@else-->
            <!--<a style="cursor: pointer;" data-toggle="modal" data-target="#vendorloginModal">{{$lang->sale}}</a>-->
    ...
    @endif
        ...
        @if($lang->rtl == 1)
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-5">
                        <div class="header-menu-wrap">
                            <ul>
                                <li><a class="{{ request()->is('/hot-of-the-fire') ? 'active' : '' }}" href="{{route('front.hot-of-the-fire')}}" style="color: #0a2354;">Latest Collection</a></li>
                                <li><a class="{{ request()->is('/corporate-collaboration') ? 'active' : '' }}" href="{{route('front.corporate-collaboration')}}" style="color: #0a2354;">Corporate Sales <i class="fa fa-angle-down"></i></a>
                                
                                    <ul>
                                        @php 
                                            $corporate = DB::table('categories')->where('status','0')->get();
                                        @endphp
                                        @foreach($corporate as $cor_category)
                                        <li>
                                            <a href="{{route('front.category',$cor_category->cat_slug)}}">
                                            <!--@if($category->photo != null)
                                            <img src="{{asset('assets/images/'.$category->photo)}}" alt="">
                                            @else
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            @endif-->
                                            {{ $cor_category->cat_name }}
                                            </a>
                                        </li>
                                        @endforeach
                                    </ul>
                                ...
                                <li><a class="{{ request()->is('/dev-shishu') ? 'active' : '' }}" href="{{route('front.dev-shishu')}}" style="color: #0a2354;">Dev Shishu</a></li>
                                <li><a class="{{ request()->is('/design-hope') ? 'active' : '' }}" href="{{route('front.design-hope')}}" style="color: #0a2354;">Design Your Hope</a></li>
                ...
                <!--        <div class="header-bottom-left-wrap" style="background-color:#f3f3f3; color: #0a2354;">-->
                <!--        <h5><b>ALL CLOTHING</b> <i class="fa fa-bars"></i></h5>-->
                <!--            <ul style="background: #0e3b914d;">-->
                ...
                <!--                        <li><a style="font-size: 17px;" href="{{route('front.subcategory',$subcategory->sub_slug)}}">{{$subcategory->sub_name}} <i class="{{ count($subcategory->childs) > 0 ? 'fa fa-angle-left' : ''}}"></i></a>-->
                <!--                        @if(count($subcategory->childs) > 0)-->
                <!--                            <ul style="background: #0e3b914d;overflow: scroll;height: 350px;">-->
                <!--    @foreach($subcategory->childs()->where('status','=',1)->get() as $childcategory)-->
                <!--                                <li><a style="font-size: 17px;" href="{{route('front.childcategory',$childcategory->child_slug)}}">{{$childcategory->child_name}}</a></li>-->
                <!--    @endforeach    -->
        ...
        @else
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-5">
                <!--        <div class="header-bottom-left-wrap" style="background-color:#f3f3f3; color: #0a2354; font-size:17px;">-->
                <!--        <h5><i class="fa fa-bars"></i> ALL CLOTHING </h5>-->
                <!--            <ul style="background: #0e3b914d;">-->
                <!--            @foreach($categories as $category)-->
                <!--                <li><a href="{{route('front.category',$category->cat_slug)}}">-->
                ...
                <!--@foreach($category->subs()->where('status','=',1)->get() as $subcategory)                                                   -->
                <!--                        <li><a style="font-size: 17px;" href="{{route('front.subcategory',$subcategory->sub_slug)}}">{{ $subcategory->sub_name}} <i class="{{ count($subcategory->childs) > 0 ? 'fa fa-angle-right' : ''}}"></i></a>-->
                <!--                        @if(count($subcategory->childs) > 0)-->
                <!--                            <ul style="background: #0e3b914d;overflow: scroll;height: 350px;">-->
                ...
                <!--        </div>-->
                    ...
                    <div class="mobileMenuActive"></div>
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-5 text-center" style="padding-bottom:10px;">
                        <div class="header-menu-wrap">
                            <ul>
                                @foreach($categories as $key => $category)
                                    <li><a href="{{route('front.category',$category->cat_slug)}}">
                                        ...
                                        @if(count($category->subs) > 0)
                                        <ul style="background: #fff;float: left;overflow: scroll;width:700px;left: 0;height:450px;">
                                            <div class="row" style="width:700px;">
                                                @foreach($category->subs()->where('status','=',1)->get() as $subcategory)
                                                    <div class="col-md-4" style="float: left;color: black;text-decoration: none;display: block;">
                                                        <a style="font-size: 20px;" href="{{route('front.subcategory',$subcategory->sub_slug)}}">{{ $subcategory->sub_name}}</a>
                                                        @if(count($subcategory->childs) > 0)
                                                        @foreach($subcategory->childs()->where('status','=',1)->get() as $childcategory)
                                                        <a style="font-size: 17px;" href="{{route('front.childcategory',$childcategory->child_slug)}}">{{ $childcategory->child_name }}</a>
                                                        @endforeach
                                                        @endif
                                                    </div>
                                                @endforeach
                            ...
                            @endphp
                           @endforeach
                                <li><a class="{{ request()->is('/corporate-collaboration') ? 'active' : '' }}" href="{{route('front.corporate-collaboration')}}">CORPORATE SALES</a></li>
                               <!--<li><a class="{{ request()->is('/hot-of-the-fire') ? 'active' : '' }}" href="{{route('front.hot-of-the-fire')}}" style="color: #0a2354;">Latest Collection</a></li>-->
                               <!-- <li><a class="{{ request()->is('/corporate-collaboration') ? 'active' : '' }}" href="{{route('front.corporate-collaboration')}}" style="color: #0a2354;">Corporate Sales <i class="fa fa-angle-down"></i></a>-->
    ...
    <footer class="footer-wrap">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="single-footer-wrap information">
                            ...
                            <ul>
                                 ...
                                 @foreach($pages as $pg)
                                    <li><a href="{{route('front.page',$pg->slug)}}"><i class="fa fa-circle" style="color:#f02121;"></i> &nbsp; {{strtoupper($pg->title)}}</a></li>
                                @endforeach
                                <li><a href="{{route('front.contact')}}"><i class="fa fa-circle" style="color:#f02121;"></i> &nbsp; CONTACT US</a></li>
                                <!--
                                <li><a href="#"><i class="fa fa-angle-double-right"></i> &nbsp; Who we are</a></li>
                                <li><a href="#"><i class="fa fa-angle-double-right"></i> &nbsp; Our Motivation</a></li>
                                <li><a href="#"><i class="fa fa-angle-double-right"></i> &nbsp; History and Importance</a></li>
                                <li><a href="#"><i class="fa fa-angle-double-right"></i> &nbsp; Key Reasons of Clothing</a></li>
                                <li><a href="#"><i class="fa fa-angle-double-right"></i> &nbsp; Our Vission</a></li>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="single-footer-wrap">
                            ...
                            <p dir="rtl">
                               Koel Shop is the world of fashion and apparels, which you dream for. Your attire defines your look as well as your personality. Clothing derives power that you can make it. In this global village, clothing plays a great role in life style and Fashion. People from all sectors want to have confident, smarter, and stylish appearance. Hence, textile, clothing and fashion industries are inventing innovative products to reach the desire of their consumers.
                            </p>
                        </div>
                    </div>
                @else
        ...
        <div class="footer-bottom-wrap">
            <div class="container">
                <div class="row">
                    @if($lang->rtl == 1)
                    <div class="col-lg-3 col-md-6 col-sm-5 col-xs-12" style="padding-top: 40px;">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-7 col-xs-12" style="padding-top: 40px;">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-7 col-xs-12">
                        <div class="footer-copyright-area">
                            <img class="img-for-footer" src="{{asset('assets/front/images/ssl.png')}}" alt="footer image">
                        </div>
                    </div>
                    @else
                    <div class="col-lg-3 col-md-6 col-sm-7 col-xs-12" style="padding-top: 40px;">
...
<script src="{{asset('assets/front/js/all.js')}}"></script>
    ...
    <script type="text/javascript">
        $(".header-bottom-left-wrap").meanmenu({
            meanMenuOpen: '<i class="fa fa-bars"></i>' +   ' {{ $all_clothing }} '    + '<i class="fa fa-angle-down"></i>',
            meanMenuClose: '<i class="fa fa-bars"></i>' +   ' {{ $all_clothing }} '    + '<i class="fa fa-times"></i>',
