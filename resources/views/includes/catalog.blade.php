                <div class="col-lg-3 col-md-4 col-sm-12 col-xs-12">
                    <div class="product-filter-option">
                        <h3 class="filter-title">{{$lang->doa}}</h3>
...
@if(isset($vendor))
    <div class="product-filter-option">
        <h3 class="filter-title">{{$lang->doci}}</h3>
...
@endif
                    ...
                    <div class="product-filter-option">
                        <h3 class="filter-title">{{$lang->dosp}}</h3>
                        @if(isset($cat))
                    ...
                    <div class="product-filter-option">
                        <h3 class="filter-title">{{$lang->doem}}</h3>
          ...
          <div class="product-filter-option description">
            <h3 class="filter-title">{{$lang->vendor_description}}</h3>
            ...
            <ul style="direction: ltr;">
              ...
              @endif
              @if($vendor->l_check != 0)
              <li><a href="{{$vendor->l_url}}"><i class="fa fa-instagram"></i> Instagram</a></li>
              @endif
            </ul>
          </div>
