                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="panel panel-default admin top-reference-area">
                                    <div class="panel-heading">Todays Viewers Count</div>
                                    <div class="panel-body">
                                        <!--<div id="chartContainer-topReference"></div>-->
                                        @php
                                        $today_date = date('Y-m-d');
                                            $todays_count = DB::table('counters')->where('today',$today_date)->sum('todays_count');
                                        @endphp
                                        <!--<h3 style="text-align:center;color:#00BCD4;">{{$todays_count}}</h3>-->
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="panel panel-default admin top-reference-area">
                                    <div class="panel-heading">Total Viewers Count</div>
                                    <div class="panel-body">
                                        <!--<div id="chartContainer-os"></div>-->
                                        @php
                                            $total_count = DB::table('counters')->sum('total_count');   
                                        @endphp
                                        <h3 style="text-align:center;color:#00BCD4;">{{$total_count}}</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
