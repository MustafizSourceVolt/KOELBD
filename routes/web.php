...
*/
  ...
  Route::get('/wanted-brand', 'AdminWantedBrandController@index')->name('admin-wanted-brand');
  Route::post('/wanted-brand-submit', 'AdminWantedBrandController@store')->name('admin-wanted-brand-submit');
  Route::get('/wanted-brand/{id}/show', 'AdminWantedBrandController@show')->name('admin-wanted-view');
  ...
  Route::get('/corporate-collaboration', 'CorCollabController@index')->name('admin-corporate-collaboration');
  Route::get('/corporate-collaboration/create', 'CorCollabController@create')->name('admin-cor-collaboration-create');
  Route::post('/corporate-collaboration/create', 'CorCollabController@store')->name('admin-corporate-collaboration-store');
  Route::get('/corporate-collaboration/edit/{id}', 'CorCollabController@edit')->name('admin-cor-collaboration-edit');
  Route::post('/corporate-collaboration/update/{id}', 'CorCollabController@update')->name('admin-cor-collaboration-update');
  Route::get('/corporate-collaboration/delete/{id}', 'CorCollabController@destroy')->name('admin-cor-collaboration-delete');
  
  Route::get('/dev-shishu', 'DevShishuController@index')->name('admin-dev-shishu');
  Route::get('/dev-shishu/create', 'DevShishuController@create')->name('admin-dev-shishu-create');
  Route::post('/dev-shishu/create', 'DevShishuController@store')->name('admin-dev-shishu-store');
  Route::get('/dev-shishu/edit/{id}', 'DevShishuController@edit')->name('admin-dev-shishu-edit');
  Route::post('/dev-shishu/update/{id}', 'DevShishuController@update')->name('admin-dev-shishu-update');
  Route::get('/dev-shishu/delete/{id}', 'DevShishuController@destroy')->name('admin-dev-shishu-delete');
  
  Route::get('/design-your-hope', 'DesignYourHopeController@index')->name('admin-design-your-hope');
  Route::get('/design-your-hope/create', 'DesignYourHopeController@create')->name('admin-design-your-hope-create');
  Route::post('/design-your-hope/create', 'DesignYourHopeController@store')->name('admin-design-your-hope-store');
  Route::get('/design-your-hope/edit/{id}', 'DesignYourHopeController@edit')->name('admin-design-your-hope-edit');
  Route::post('/design-your-hope/update/{id}', 'DesignYourHopeController@update')->name('admin-design-your-hope-update');
  Route::get('/design-your-hope/delete/{id}', 'DesignYourHopeController@destroy')->name('admin-design-your-hope-delete');
  ...
  Route::get('/corporate-collaboration/{status}', 'PageSettingController@corcolupdate')->name('admin-corporate-collaboration-update');
  ...
  Route::get('/corporate-collaboration','FrontendController@corporateCollaboration')->name('front.corporate-collaboration');
  Route::get('/dev-shishu','FrontendController@devShishu')->name('front.dev-shishu');
  Route::get('/design-hope','FrontendController@designHope')->name('front.design-hope');
  Route::get('/hot-of-the-fire','FrontendController@hotTheFire')->name('front.hot-of-the-fire');
  
  Route::get('/best-product','FrontendController@bestProduct')->name('front.best-product');
  Route::get('/request-new-brand','FrontendController@requestBrand')->name('front.request-new-brand');
